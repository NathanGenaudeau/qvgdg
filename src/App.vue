  ...
  <v-layout class="app rounded rounded-md">
    <v-app-bar>
      <template v-slot:prepend>
        ...
        <v-btn @click="router.push({ name: 'Manche 1-2' })">La poêlée & Le panier garni</v-btn>
        <v-btn @click="router.push({ name: 'Manche 3' })">La cueillette surprise</v-btn>
        <v-btn @click="router.push({ name: 'Manche 4' })">Le Quadri-Cèpes</v-btn>
        <v-btn @click="router.push({ name: 'Manche 5' })">Le duel des chefs</v-btn>
      </template>
